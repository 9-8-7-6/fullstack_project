...
import {differenceInDays, eachDayOfInterval, setDate, format } from 'date-fns'
    ...
    return(
        <aside className="mt-6 p-6 col-span-2 rounded-xl border border-gray-300 shadow">
            ...
            <div 
                ...
                className="w-full mb-6 py-6 text-center text-white bg-project hover:bg-project-dark  rounded-xl"
            >
                Book
            </div>
